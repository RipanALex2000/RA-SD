...
void sex(char s)
{
    switch(s)
    {
            case '1':{ cout<<"Persoana  de sex masculin nascute intre anii 1900 - 1999"<<endl; break; }
            case '2':{ cout<<"Persoana  de sex feminin nascute intre anii 1900 - 1999"<<endl; break; }
            case '3':{ cout<<"Persoana  de sex masculin nascute intre anii 1800 - 1899"<<endl; break; }
            case '4':{ cout<<"Persoana  de sex feminin nascute intre anii 1800 - 1899"<<endl; break; }
            case '5':{ cout<<"Persoana  de sex masculin nascute intre anii 2000 - 2099"<<endl; break; }
            case '6':{ cout<<"Persoana  de sex feminin nascute intre anii 2000 - 2099"<<endl; break; }
            case '7':{ cout<<"Persoana  rezidente, de sex masculin"<<endl; break; }
            case '8':{ cout<<"Persoana rezidente, de sex feminin"<<endl; break; }
            default: 
                cout<<"NULL"<<endl;
    }
}
